<?php
// source: /Library/WebServer/Documents/configNeon/app/config/config.neon 
// source: /Library/WebServer/Documents/configNeon/app/config/config.local.neon 

class Container_9ffcdc4279 extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			'Nette\Object' => array(
				array(
					...
					'security.user',
					'session.session',
					'26_App_FrontendModule_Forms_SignFormFactory',
					'application.1',
					'application.2',
					'application.3',
					'application.4',
			...
			'App\FrontendModule\Forms\SignFormFactory' => array(
				1 => array(
					'26_App_FrontendModule_Forms_SignFormFactory',
				),
			),
			'App\Frontend\Model\DatabaseDriver' => array(1 => array('27')),
			'App\Presenters\Backend\BasePresenter' => array(array('application.1', 'application.2')),
			...
			'App\Presenters\Backend\ErrorPresenter' => array(array('application.1')),
			'App\Presenters\Backend\HomepagePresenter' => array(array('application.2')),
			...
			'App\FrontendModule\Presenters\ErrorPresenter' => array(array('application.3')),
			'App\FrontendModule\Presenters\HomepagePresenter' => array(array('application.4')),
			'App\FrontendModule\Presenters\SignPresenter' => array(array('application.5')),
		...
		'services' => array(
			'26_App_FrontendModule_Forms_SignFormFactory' => 'App\FrontendModule\Forms\SignFormFactory',
			'application.1' => 'App\Presenters\Backend\ErrorPresenter',
			'application.2' => 'App\Presenters\Backend\HomepagePresenter',
			'application.3' => 'App\FrontendModule\Presenters\ErrorPresenter',
			'application.4' => 'App\FrontendModule\Presenters\HomepagePresenter',
			'application.5' => 'App\FrontendModule\Presenters\SignPresenter',
			...
			27 => 'App\Frontend\Model\DatabaseDriver',
		),
		'tags' => array(
			'inject' => array(
				'application.1' => TRUE,
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/Library/WebServer/Documents/configNeon/app',
			'wwwDir' => '/Library/WebServer/Documents/configNeon/www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => '/Library/WebServer/Documents/configNeon/app/../temp',
		));
	}


	/**
	 * @return App\FrontendModule\Forms\SignFormFactory
	 */
	public function createService__26_App_FrontendModule_Forms_SignFormFactory()
	{
		$service = new App\FrontendModule\Forms\SignFormFactory($this->getService('security.user'));
		return $service;
	}


	/**
	 * @return App\Presenters\Backend\ErrorPresenter
	 */
	public function createServiceApplication__1()
	{
		$service = new App\Presenters\Backend\ErrorPresenter($this->getService('tracy.logger'));
	...
	/**
	 * @return App\Presenters\Backend\HomepagePresenter
	 */
	public function createServiceApplication__2()
	{
		$service = new App\Presenters\Backend\HomepagePresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->invalidLinkMode = 5;
	...
	public function createServiceApplication__4()
	{
		...
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->database = $this->getService('27');
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	/**
	 * @return App\FrontendModule\Presenters\SignPresenter
	 */
	public function createServiceApplication__5()
	{
		$service = new App\FrontendModule\Presenters\SignPresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->invalidLinkMode = 5;
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/Library/WebServer/Documents/configNeon/app'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/Library/WebServer/Documents/configNeon/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/Library/WebServer/Documents/configNeon/app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		return new Container_9ffcdc4279_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('/Library/WebServer/Documents/configNeon/app/../temp/cache/latte');
	...
	/**
	 * @return App\Frontend\Model\DatabaseDriver
	 */
	public function createService__27()
	{
		$service = new App\Frontend\Model\DatabaseDriver($this->getService('database.default.context'), '/Library/WebServer/Documents/configNeon/www');
		return $service;
	}
...
final class Container_9ffcdc4279_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
