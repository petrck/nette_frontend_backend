<?php
// source: /Library/WebServer/Documents/configNeon/app/Frontend/templates/Homepage/default.latte

class Templateaf536ecd569a68909dddbbd841c5dab5 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('982efc9bf9', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb03ac6663e5_content')) { function _lb03ac6663e5_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb09f80acecc_title')) { function _lb09f80acecc_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb9be215669b_scripts')) { function _lb9be215669b_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbeac351b000_head')) { function _lbeac351b000_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
